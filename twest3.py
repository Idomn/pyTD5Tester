...
def send_packet(data, res_size):
    return %a;\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08H\x00\x00\x00\x00\x00 \x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00Q
response = send_packet(1,2)
for i in range(0, 36):
    for j in range(0, 7):
